...
class Handover(models.Model):
    ...
    action_user = models.ForeignKey(User, related_name='handover_action_user', on_delete=models.CASCADE, null=True,
                                    blank=True)
...
class AssetType(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name='父菜单', related_name='assettype_type', null=True, blank=True,
...
class Asset(models.Model):
    ...
    asset_area = models.ForeignKey(Area, related_name='area_for_asset', verbose_name='所属区域', on_delete=models.CASCADE,
...
class AssetRequest(models.Model):
    ...
    asset_type = models.ForeignKey(AssetType, related_name='type_for_assetrequest', verbose_name='资产类型',
                                   on_delete=models.CASCADE, null=True, limit_choices_to={'parent__isnull': False})
    action_user = models.ForeignKey(User, related_name='assetrequestaction_for_user', on_delete=models.CASCADE,
                                    null=True, blank=True)
...
class InternetInfo(models.Model):
    ...
    web_framework = models.CharField('开发框架', max_length=50, blank=True, null=True)
    web_framework_version = models.CharField('开发框架版本', max_length=50, blank=True, null=True)
