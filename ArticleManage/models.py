...
class ArticleType(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name=u'父菜单',
                               related_name='article_type_type',
...
class Article(models.Model):
    ...
    article_start_time = models.DateTimeField('添加时间', auto_now_add=True)
    article_update_time = models.DateTimeField('更新时间', auto_now=True)

    article_type = models.ForeignKey(ArticleType,
                                     related_name='article_type_for_article',
                                     on_delete=models.CASCADE,
                                     null=True, verbose_name='文章分类',
                                     limit_choices_to={'parent__isnull': False})

    article_user = models.ForeignKey(User,
                                     related_name='article_for_user',
...
class ArticleComments(models.Model):
    ...
    article_comment_start_time = models.DateTimeField('添加时间', auto_now_add=True)

    article_comment_article = models.ForeignKey(User,
                                                related_name='article_comment_for_article',
                                                on_delete=models.CASCADE,
                                                verbose_name='文章关联')

    article_comment_user = models.ForeignKey(User,
                                             related_name='article_comment_for_user',
                                             on_delete=models.CASCADE)
