    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LANPort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='LANport_for_mapped', to='AssetManage.PortInfo', verbose_name='内网端口')),
                ...
                ('WANPort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='WANport_for_mapped', to='AssetManage.PortInfo', verbose_name='外网端口')),
