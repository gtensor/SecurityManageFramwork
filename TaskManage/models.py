...
class Task(models.Model):
    ...
    task_scanner = models.ForeignKey(Scanner, related_name='scanner_to_task', on_delete=models.CASCADE,
                                     verbose_name='扫描器')
    scanner_police = models.ForeignKey(ScannerPolicies, related_name='police_to_scanner', null=True,
                                       on_delete=models.CASCADE, verbose_name='扫描策略')

    task_user = models.ForeignKey(User, related_name='task_for_user', on_delete=models.CASCADE, verbose_name='任务用户')
    action_user = models.ForeignKey(User, related_name='taskrequestaction_for_user', on_delete=models.CASCADE,
